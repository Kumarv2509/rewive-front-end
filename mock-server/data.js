...
export const decisionLedger = [
  ...
  { id: 'led-fnvpp1', persona: 'fnv_production', title: 'Park — pre-pack capacity parked on a 92% re-alert rule', subtitle: 'Summer peak hits line capacity mid-August at trend', madeBy: { type: 'human', name: 'Rania Kassem', initials: 'RK', avatarBg: '#15803D' }, informedBy: { type: 'agent', name: 'Logistics agent' }, date: '07 Jul', verdict: 'too_early', measuredImpact: { text: 'parked — watching the re-alert rule', direction: 'flat' }, function: 'procurement', findingId: 'fmcg-f-fnv-prepack', entity: 'UAE Trading Co.', region: 'UAE' },
  ...
  { id: 'led0', persona: 'sales_supervisor', title: 'Accept — OSA back above 96% in top-40 stores', subtitle: 'On-shelf availability finding · recovery target watched', madeBy: { type: 'human', name: 'Layla Nasser', initials: 'LN', avatarBg: '#0D9488' }, informedBy: { type: 'agent', name: 'Commercial agent' }, date: '02 Jun', verdict: 'too_early', measuredImpact: { text: 'measuring…', direction: 'flat' }, function: 'finance', findingId: 'fmcg-f-5', entity: 'UAE Trading Co.', region: 'UAE' },
  { id: 'led8', persona: 'cfo', title: 'Park — Egypt receivables on a re-alert rule', subtitle: 'Parked at 22% past 60 days · re-alert fired 28 Jun', madeBy: { type: 'human', name: 'Daniel Chen', initials: 'DC', avatarBg: '#1D4ED8' }, informedBy: { type: 'agent', name: 'Finance agent' }, date: '14 May', verdict: 'not_worked', measuredImpact: { text: 're-alert rule fired · back open', direction: 'down' }, function: 'finance', findingId: 'fmcg-f-9', assessorNote: 'Assessor agent: the park did not hold — the Egypt book crossed the re-alert line six weeks later and the finding re-opened one level up.', entity: 'Egypt Foods S.A.E.', region: 'Egypt' },
  ...
  { id: 'led4', persona: 'cfo', title: 'Extend payment terms — distributor KSA', subtitle: 'Cash-flow scenario B · recovery target regressed', madeBy: { type: 'human', name: 'Praveen', initials: 'PJ', avatarBg: '#D97706' }, informedBy: { type: 'agent', name: 'Forecast Worker' }, date: '14 Apr', verdict: 'not_worked', measuredImpact: { text: '−AED 40k DSO cost', direction: 'down' }, function: 'finance', findingId: 'fmcg-f-h3', assessorNote: 'Assessor agent: 60 days on, DSO worsened to 81 days — the extension legitimised the stretch instead of stopping it. The recovery target is regressed and awaiting a re-disposition.', entity: 'Gulf Distribution Co.', region: 'KSA' },
