...
export let pendingDecisions = [
  {
    id: '492bde51-12b0-4d3e-bf74-2d909d3357d4',
    action_type: 'inquiry',
    action_title: 'Urgent Inquiry Regarding Investment Status',
    action_summary: 'Bhuvaneswari Rajasekaran has sent an urgent inquiry regarding the status of her recent investments. She is awaiting confirmation of transaction logs and data verification with the fund house.',
    params: { from_email: 'b.rajasekaran@megalon.de', to_email: 'bhuvana.r@gaansoft.com' },
    assigned_to: null, status: 'pending', priority: 'medium',
    created_on: '2026-05-20T05:43:38.905005+00:00', triggered_on: '2026-05-20T05:43:38.905005+00:00',
    updated_on: '2026-05-20T05:43:38.956046+00:00', created_by: null, updated_by: null,
    client_ref: null, user_id: '789', resolved_at: null, resolved_by: null, rejection_reason: null,
  },
  {
    id: 'd5d50015-b4af-466c-b4da-401eecf17c52',
    action_type: 'transaction',
    action_title: 'Partial Redemption Request',
    action_summary: 'Avinash is requesting a partial redemption of ₹5,00,000 from his holdings in Adithya Birla. He wants the proceeds reallocated into the Bluechip Growth Fund by the next available NAV cut-off.',
    params: { from_email: 'b.rajasekaran@megalon.de', to_email: 'bhuvana.r@gaansoft.com' },
    assigned_to: null, status: 'pending', priority: 'medium',
    created_on: '2026-05-20T07:58:39.895952+00:00', triggered_on: '2026-05-20T07:58:39.895952+00:00',
    updated_on: '2026-05-20T07:58:39.936855+00:00', created_by: null, updated_by: null,
    client_ref: null, user_id: '789', resolved_at: null, resolved_by: null, rejection_reason: null,
  },
  {
    id: '065c5bea-eff4-4af6-b03e-affcf06fd030',
    action_type: 'transaction',
    action_title: 'Transfer Request',
    action_summary: 'Kamal Pandi V is requesting a transfer of $5,850.00 out of his account. He has also mentioned additional payments and expenses totaling $2,078.50 for loan payments and various other expenses.',
    params: { from_email: 'kamalpandi.v@gaansoft.com', to_email: 'bhuvana.r@gaansoft.com' },
    assigned_to: null, status: 'pending', priority: 'medium',
    created_on: '2026-05-20T14:50:31.479815+00:00', triggered_on: '2026-05-20T14:50:31.479815+00:00',
    updated_on: '2026-05-20T14:50:31.528978+00:00', created_by: null, updated_by: null,
    client_ref: null, user_id: '789', resolved_at: null, resolved_by: null, rejection_reason: null,
  },
  {
    id: '086f9627-4f30-4db9-ba87-1ae7996f74fc',
    action_type: 'inquiry',
    action_title: 'Urgent Inquiry About Current Holdings',
    action_summary: 'Bhuvaneswari Rajasekaran is worried about her current holdings due to the sudden mid-cap crash this morning. She is asking if her investments are safe and whether she should move her money into gold or cash.',
    params: { from_email: 'b.rajasekaran@megalon.de', to_email: 'bhuvana.r@gaansoft.com' },
    assigned_to: null, status: 'pending', priority: 'medium',
    created_on: '2026-05-22T06:46:05.922838+00:00', triggered_on: '2026-05-22T06:46:05.922838+00:00',
    updated_on: '2026-05-22T06:46:37.915903+00:00', created_by: null, updated_by: null,
    client_ref: null, user_id: '789', resolved_at: null, resolved_by: null, rejection_reason: null,
  },
  {
    id: 'b71cf429-24d1-44f4-a9fe-7fadd92bd6fc',
    action_type: 'request',
    action_title: 'Approval of Proposed Q3 Marketing Budget',
    action_summary: 'Devaki Habib is requesting approval for the proposed Q3 marketing budget of ₹15,00,000. The attached document contains a detailed breakdown of planned expenditures and expected ROI.',
    params: { from_email: 'devaki.h@gaansoft.com', to_email: 'bhuvana.r@gaansoft.com' },
    assigned_to: null, status: 'pending', priority: 'medium',
    created_on: '2026-06-16T07:08:00.509675+00:00', triggered_on: '2026-06-16T07:08:00.509675+00:00',
    updated_on: '2026-06-16T07:08:00.572962+00:00', created_by: null, updated_by: null,
    client_ref: null, user_id: '30', resolved_at: null, resolved_by: null, rejection_reason: null,
  },
  {
    id: 'b4461245-6d91-4be5-910f-811585bb3fcc',
    action_type: 'transaction',
    action_title: 'Liquidation of Tech Holdings',
    action_summary: 'Ganesh is requesting to liquidate his entire position in NVIDIA (NVDA) and Tesla (TSLA) immediately. He wants the proceeds moved into his cash sweep account before the market closes today.',
    params: { from_email: ['b.rajasekaran@megalon.de'], to_email: 'bhuvana.r@gaansoft.com' },
    assigned_to: null, status: 'pending', priority: 'medium',
    created_on: '2026-06-04T02:53:31.796320+00:00', triggered_on: '2026-06-04T02:53:31.796320+00:00',
    updated_on: '2026-06-04T02:53:31.840098+00:00', created_by: null, updated_by: null,
    client_ref: null, user_id: '36', resolved_at: null, resolved_by: null, rejection_reason: null,
  },
  {
    id: '036de7b7-9783-49c0-8536-43113aa0bb7d',
    action_type: 'request',
    action_title: 'Approval for Payment of Invoice #INV 2026 1045',
    action_summary: 'Muthu Kumaran is requesting approval for the payment of Invoice #INV 2026 1045 from ABC Solutions Pvt. Ltd. for ₹75,000, pertaining to software maintenance services provided during June 2026.',
    params: { from_email: 'muthukumaran.p@gaansoft.com', to_email: 'bhuvana.r@gaansoft.com' },
    assigned_to: null, status: 'pending', priority: 'medium',
    created_on: '2026-06-16T09:58:17.057048+00:00', triggered_on: '2026-06-16T09:58:17.057048+00:00',
    updated_on: '2026-06-16T09:58:17.110140+00:00', created_by: null, updated_by: null,
    client_ref: null, user_id: '30', resolved_at: null, resolved_by: null, rejection_reason: null,
  },
  {
    id: '59aba58a-0282-4f61-851b-d375712fd658',
    action_type: 'transaction',
    action_title: 'Sell 500 shares of Apple (AAPL)',
    action_summary: 'Robert Martinez wants to sell 500 shares of Apple (AAPL) from account #789456 at market price today. He states he wants to take profits given the recent run-up.',
    params: { from_email: ['b.rajasekaran@megalon.de'], to_email: 'bhuvana.r@gaansoft.com' },
    assigned_to: null, status: 'pending', priority: 'medium',
    created_on: '2026-06-04T06:07:49.612543+00:00', triggered_on: '2026-06-04T06:07:49.612543+00:00',
    updated_on: '2026-06-04T06:07:49.652562+00:00', created_by: null, updated_by: null,
    client_ref: null, user_id: '36', resolved_at: null, resolved_by: null, rejection_reason: null,
  },
];
...
export const dashboardWidgets = {
  live_runs_today: { rows: liveRuns, summary_rows: null },
  agent_actions_today: { rows: [{ action_count: 87 }], summary_rows: null },
  process_count_today: { rows: [{ process_count: 12 }], summary_rows: null },
  process_traces_today: { rows: pulse, summary_rows: null },
  analytics_agent_approvals: { rows: pendingDecisions, summary_rows: null },
  analytics_top_performer: { rows: [topPerformer], summary_rows: null },
  workflow_execution_count_total: { rows: [{ execution_count: 1276, completed_count: 895, running_count: 381 }], summary_rows: null },
};
...
export const users = [
  {
    ...
    user_name: 'Admin',
    password: 'admin123',
    rememberMeToken: 'mock-token-admin',
    client_ref: 'CUST-001',
    fk_customer_account: 'CUST-001',
  ...
  },
  {
    ...
    user_name: 'Demo',
    password: 'demo123',
    rememberMeToken: 'mock-token-demo',
    client_ref: 'CUST-002',
    fk_customer_account: 'CUST-002',
    permissions: ['read'],
  },
];
