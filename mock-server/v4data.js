...
export const shadowOrgs = {
  fmcg: {
    industry: 'fmcg',
    agents: [
      { id: 'fmcg-sa-chief', persona: 'coo', name: 'Chief of staff counterpart', streamKey: null, humanOwner: { name: 'Kumara Vijayan', initials: 'KV', avatarBg: '#4F46E5', role: 'Co-founder · Admin' }, watchesNodeIds: ['fmcg-t-rev', 'fmcg-t-ebitda', 'fmcg-t-share', 'fmcg-t-cash'], openFindings: 0, slaBreaches: 0, temperament: 35, health: 'attention', lastFindingAt: '2026-07-05T09:40:00Z', reportsToAgentId: null },
      ...
      { id: 'fmcg-sa-quality', persona: 'operations_head', name: 'Quality counterpart', streamKey: 'quality', humanOwner: { name: 'Amira Hassan', initials: 'AH', avatarBg: '#BE185D', role: 'Quality & food safety lead' }, watchesNodeIds: ['fmcg-k-ppm', 'fmcg-k-audit', 'fmcg-d-complaints'], openFindings: 0, slaBreaches: 0, temperament: 30, health: 'healthy', lastFindingAt: '2026-06-28T11:30:00Z', reportsToAgentId: 'fmcg-sa-chief' },
      { id: 'fmcg-sa-finance', persona: 'cfo', name: 'Finance counterpart', streamKey: 'finance', humanOwner: { name: 'Daniel Chen', initials: 'DC', avatarBg: '#1D4ED8', role: 'FP&A lead' }, watchesNodeIds: ['fmcg-k-gm', 'fmcg-k-cogsvar', 'fmcg-k-wcd', 'fmcg-k-tradepct', 'fmcg-d-tradeledger'], openFindings: 0, slaBreaches: 0, temperament: 40, health: 'attention', lastFindingAt: '2026-07-03T16:00:00Z', reportsToAgentId: 'fmcg-sa-chief' },
      { id: 'fmcg-sa-marketing', persona: 'commercial_finance', name: 'Marketing counterpart', streamKey: 'marketing', humanOwner: { name: 'Sara Idris', initials: 'SI', avatarBg: '#9333EA', role: 'Marketing director' }, watchesNodeIds: ['fmcg-k-npd', 'fmcg-k-croi'], openFindings: 0, slaBreaches: 0, temperament: 35, health: 'healthy', lastFindingAt: '2026-06-30T10:15:00Z', reportsToAgentId: 'fmcg-sa-chief' },
      { id: 'fmcg-sa-people', persona: 'coo', name: 'People counterpart', streamKey: 'people', humanOwner: { name: 'Noura Khalid', initials: 'NK', avatarBg: '#C2410C', role: 'People partner' }, watchesNodeIds: ['fmcg-k-attr', 'fmcg-k-lti'], openFindings: 0, slaBreaches: 0, temperament: 25, health: 'healthy', lastFindingAt: '2026-06-25T08:00:00Z', reportsToAgentId: 'fmcg-sa-chief' },
    ],
  },
  healthcare: {
    industry: 'healthcare',
    agents: [
      { id: 'hc-sa-chief', persona: 'coo', name: 'Chief of staff counterpart', streamKey: null, humanOwner: { name: 'Kumara Vijayan', initials: 'KV', avatarBg: '#4F46E5', role: 'Co-founder · Admin' }, watchesNodeIds: ['hc-t-margin', 'hc-t-quality', 'hc-t-access', 'hc-t-safety'], openFindings: 0, slaBreaches: 0, temperament: 35, health: 'attention', lastFindingAt: '2026-07-04T12:00:00Z', reportsToAgentId: null },
      ...
      { id: 'hc-sa-finance', persona: 'cfo', name: 'Finance counterpart', streamKey: 'finance', humanOwner: { name: 'Daniel Chen', initials: 'DC', avatarBg: '#1D4ED8', role: 'FP&A lead' }, watchesNodeIds: ['hc-k-labor', 'hc-k-costdischarge', 'hc-k-cashdays', 'hc-d-gl'], openFindings: 0, slaBreaches: 0, temperament: 40, health: 'healthy', lastFindingAt: '2026-07-02T13:45:00Z', reportsToAgentId: 'hc-sa-chief' },
  ...
  manufacturing: {
    ...
    agents: [
      { id: 'mfg-sa-chief', persona: 'coo', name: 'Chief of staff counterpart', streamKey: null, humanOwner: { name: 'Kumara Vijayan', initials: 'KV', avatarBg: '#4F46E5', role: 'Co-founder · Admin' }, watchesNodeIds: ['mfg-t-otd', 'mfg-t-unitcost', 'mfg-t-safety'], openFindings: 0, slaBreaches: 0, temperament: 35, health: 'attention', lastFindingAt: '2026-07-05T18:00:00Z', reportsToAgentId: null },
      ...
      { id: 'mfg-sa-quality', persona: 'store_manager', name: 'Quality counterpart', streamKey: 'quality', humanOwner: { name: 'Amira Hassan', initials: 'AH', avatarBg: '#BE185D', role: 'Quality manager' }, watchesNodeIds: ['mfg-k-fpy', 'mfg-k-custppm'], openFindings: 0, slaBreaches: 0, temperament: 30, health: 'healthy', lastFindingAt: '2026-07-01T11:00:00Z', reportsToAgentId: 'mfg-sa-chief' },
      { id: 'mfg-sa-safety', persona: 'coo', name: 'Safety counterpart', streamKey: 'safety', humanOwner: { name: 'Noura Khalid', initials: 'NK', avatarBg: '#C2410C', role: 'EHS lead' }, watchesNodeIds: ['mfg-k-nearmiss'], openFindings: 0, slaBreaches: 0, temperament: 30, health: 'healthy', lastFindingAt: '2026-06-30T14:00:00Z', reportsToAgentId: 'mfg-sa-chief' },
      { id: 'mfg-sa-finance', persona: 'cfo', name: 'Finance counterpart', streamKey: 'finance', humanOwner: { name: 'Daniel Chen', initials: 'DC', avatarBg: '#1D4ED8', role: 'Plant controller' }, watchesNodeIds: ['mfg-k-costvar'], openFindings: 0, slaBreaches: 0, temperament: 40, health: 'attention', lastFindingAt: '2026-07-03T10:20:00Z', reportsToAgentId: 'mfg-sa-chief' },
    ],
  },
};
