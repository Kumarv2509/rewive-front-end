...
const healthcare = {
  ...
  decisionLedger: [
    { id: 'hc-led17', persona: 'cfo', title: 'Act — put verified patient liability on the check-in screen', subtitle: 'Desk collection stuck at 41% while patient liability share rose 6 points', madeBy: { type: 'human', name: 'Rashid', initials: 'RB', avatarBg: '#B45309' }, informedBy: { type: 'agent', name: 'Revenue cycle agent' }, date: '16 Jul', verdict: 'too_early', measuredImpact: { text: 'pilot desks 41% → 47%, control flat', direction: 'up' }, function: 'finance', findingId: 'hc-f-poscash', assessorNote: 'Assessor agent: three pilot desks are running 47% against 41% at the control desks over two weeks — the right direction, but two weeks is not the eight-week recovery target and the pilot desks are the three busiest, which is not a representative sample. Too early. Note this also releases the front-office re-alert rule on desk waivers, which was parked because the benefits display was not in that team’s control.', entity: 'Medcare Medical Centres — Sharjah', region: 'Sharjah & Northern Emirates' },
    { id: 'hc-led9', persona: 'cfo', title: 'Accept — coding backfill, watch the clean claim rate', subtitle: 'Clean claim rate fell to 82% after three senior coders left', madeBy: { type: 'human', name: 'Rashid', initials: 'RB', avatarBg: '#B45309' }, informedBy: { type: 'agent', name: 'Revenue cycle agent' }, date: '26 Jun', verdict: 'too_early', measuredImpact: { text: 'measuring… 89% of a 93% recovery target', direction: 'flat' }, function: 'finance', findingId: 'hc-f-4', assessorNote: 'Assessor agent: the backfill was already approved, so this was accepted with an recovery target rather than acted on. Clean claim rate is 89% against the 93% recovery target — two of the six required weeks are on the board. Too early to call.', entity: 'Medcare Hospital Al Safa', region: 'Dubai' },
    { id: 'hc-led11', persona: 'sales_supervisor', title: 'Park — desk co-pay waivers, re-alert rule armed', subtitle: 'Collection skipped when the patient disputes the amount, 1 in 9 visits', madeBy: { type: 'human', name: 'Omar', initials: 'OS', avatarBg: '#0369A1' }, informedBy: { type: 'agent', name: 'Front office agent' }, date: '11 Jul', verdict: 'too_early', measuredImpact: { text: 're-alert rule armed at 15% of visits', direction: 'flat' }, function: 'operations', findingId: 'hc-f-fo-poscash', assessorNote: 'Assessor agent: parked rather than acted on, because the fix — a live benefits display at the desk — is not in this team’s control. The re-alert rule fires if waivers pass 15% of visits, or if the display ships and the rate does not move within four weeks. Nothing to assess until one of those happens.', entity: 'Medcare Medical Centres — Sharjah', region: 'Sharjah & Northern Emirates' },
    { id: 'hc-led12', persona: 'store_manager', title: 'Accept — signage and check-in script rework, watch site NPS', subtitle: 'Sharjah NPS fell to 31 after the paediatrics / dermatology floor swap', madeBy: { type: 'human', name: 'Layla', initials: 'LH', avatarBg: '#9333EA' }, informedBy: { type: 'agent', name: 'Patient experience agent' }, date: '02 Jul', verdict: 'too_early', measuredImpact: { text: 'measuring… NPS 37 of a 42 recovery target', direction: 'flat' }, function: 'operations', findingId: 'hc-f-cm-nps', assessorNote: 'Assessor agent: NPS has recovered from 31 to 37 against a 42 recovery target, with three of the six required weeks on the board. Wayfinding has dropped out of the top three complaint themes. Trending right, too early to call.', entity: 'Medcare Medical Centres — Sharjah', region: 'Sharjah & Northern Emirates' },
...
const hypermarket = {
  ...
  // decisionStats derived server-side — see mock-server/halfyear.js.
  decisionLedger: [
    { id: 'hm-led1', persona: 'cfo', title: 'Accept — tag-and-case fix at Al Wahda, watch shrink', subtitle: 'Shrink at 2.4% of sales, concentrated in three categories', madeBy: { type: 'human', name: 'Ahmed', initials: 'AM', avatarBg: '#B91C1C' }, informedBy: { type: 'agent', name: 'Loss prevention agent' }, date: '24 Jul', verdict: 'too_early', measuredImpact: { text: 'measuring… 1.9% of a 1.4% recovery target', direction: 'flat' }, function: 'finance', findingId: 'hm-f-4', assessorNote: 'Assessor agent: shrink at the pilot store is down from 2.4% to 1.9% two weeks after the tagging and case-display change — the right direction, but the recovery target wants eight consecutive weeks under 1.4% and the next full stock count is the only number that settles it. Too early.', entity: 'GulfMart Al Wahda — Sharjah', region: 'Sharjah & Northern Emirates' },
