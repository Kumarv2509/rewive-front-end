...
import { usePersonaLens, type PersonaLens } from './personaLens';
import { useCurrentUser } from '../../api/dashboard';
import { PERSONA_LABEL, PERSONAS } from '../../screens/CommandCenter/personas';
...
function LensPicker() {
  ...
  if (!currentUser.isAdmin) {
    return <span className="lens-locked">{PERSONA_LABEL[currentUser.defaultPersona]} view</span>;
  }
